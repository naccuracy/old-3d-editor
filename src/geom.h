...
enum OperationType { UNION, INTERSECTION, SUBSTRUCTION };
...
class vector2f {
 public:
  ...
  float DotProduct(const vector2f& v) const;  // ��������� ������������
  float operator[](
      int i) const;  // ������������� ������ ��� ������� �� 2 ���������
  ...
  void Flip();  // ��������� �����������
  float PolarAngle();  // ���� � �������� �����������
  int Classify(const vector2f& v0, const vector2f& v1)
      const;  // ��������� ����� ������������ ������� [v0,v1]
};
// ����� ��� �������� ������� � ������������ {x,y,z}
class vector3f {
 public:
  float x, y, z;
  vector3f(float _x = 0.0, float _y = 0.0, float _z = 0.0)
      : x(_x), y(_y), z(_z){};
  vector3f(const vector2f& v) : x(v.x), y(v.y), z(0.0){};
  ...
  vector2f PrjX0Z();
  vector2f PrjY0Z();
  int Classify(const vector3f& v0, const vector3f& v1, const vector3f& v2)
      const;  // ��������� ����� ������������ ������������ [v0,v1,v2]
};
// ����� ��� �������� ����� �� ��������� �0Y
class line2d {
 public:
  ...
  line2d(const vector2f& _a, const vector2f& _b) : a(_a), b(_b){};
  int Intersect(const line2d& l, float& t) const;
  int Cross(const line2d& l, float& t) const;
  void Rotate();
  void Flip();
  vector2f Point(float t);
  bool IsVertical();
  bool IsHorizontal();
  int ClassifyPoint(const vector2f& p) const;
};
class line3d {
 public:
  vector3f a, b;
  line3d() : a(vector3f()), b(vector3f()){};
  line3d(const vector3f& _a, const vector3f& _b) : a(_a), b(_b){};
  void Flip();
  vector3f Point(float t);
  int IntersectWithBox(const line3d& bb);
  int PointInBox(const vector3f& p);
};
// ������� �����
using vector3f_array = std::vector<vector3f>;
using vector2f_array = std::vector<vector2f>;
...
//
using iEdge_array = std::vector<iEdge>;
using iFace_array = std::vector<iFace>;
// ����� �����
...
class Mesh {
 public:
  ...
  int Append(std::ofstream& f);
  int Extract(std::ifstream& f);
  Mesh();
  Mesh(const Mesh& m);
...
class BooleanMesh {
 public:
  ...
  int_array faces_group_list_A, faces_group_list_B, in_out_A, in_out_B;
  int OperationType;

  int TouchBoard(iFace f, iEdge_array board);
  int CreateGroupList(int_array& list,
                      Mesh A,
                      iEdge_array intrsct,
                      iFace_array Link);
  int GetNeiborsInfo(Mesh m, iFace_array& neibors);
  int InOutInfo1(Mesh mA,
                 Mesh mB,
...
int Obhod(vector3f a,
          vector3f b,
          vector3f c,
          int lr);  // lr=0- left =1 -right //return 0 �� ������� 1 - ������
...
using Ring_array = std::vector<Ring>;
#endif
